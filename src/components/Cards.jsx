...
const Cards = () => {
    return (
        <><div className='max-md:flex max-md:flex-col max-md:h-full  bg-orange-300'>
            <div className='bg-gray-400 transition-all hover:shadow-xl  brightness-50 hover:brightness-100'>
            ...
            <div className='bg-gray-400 transition-all  hover:shadow-xl brightness-50 max- hover:brightness-100'>
